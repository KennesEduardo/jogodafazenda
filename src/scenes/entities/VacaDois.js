...
export default class vacaDois extends Phaser.Physics.Arcade.Sprite {
    /**@type {Phaser.Type.Input.KeyBoard.CursorKeys} */
    clock;


    constructor(scene, x , y, touch) {
        super(scene, x, y, 'vacaDois');
    ...
    initAnimations() {
        ...
        this.anims.create({
            key: 'parada-direito',
            frames: this.anims.generateFrameNumbers('vacaDois', {
            start: 64, end:66 }),
            frameRate: 3,
            repeat: -1
        });
        ...
        this.anims.create({
            key: 'alimentando',
            frames: this.anims.generateFrameNames('vacaDois', {
              start: 112, end: 115 
            }),
